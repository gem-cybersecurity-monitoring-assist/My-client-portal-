          ...
          <div className="grid grid-cols-2 gap-3">
            {quickAccess.map((item) => (
              <button
                ...
                className="flex h-12 items-center justify-center gap-2 rounded-lg border border-glass-border bg-transparent text-sm font-semibold text-primary transition-all hover:bg-primary/10"
              >
